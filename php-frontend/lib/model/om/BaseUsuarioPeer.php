...
abstract class BaseUsuarioPeer {
	...
	const USU_EMAIL = 'usuario.USU_EMAIL';
	...
	/** the column name for the USU_GANADOR field */
	const USU_GANADOR = 'usuario.USU_GANADOR';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UsuId', 'UsuEmail', 'UsuNombre', 'UsuClave', 'UsuEstado', 'UsuGanador', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('usuId', 'usuEmail', 'usuNombre', 'usuClave', 'usuEstado', 'usuGanador', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::USU_ID, self::USU_EMAIL, self::USU_NOMBRE, self::USU_CLAVE, self::USU_ESTADO, self::USU_GANADOR, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('usu_id', 'usu_email', 'usu_nombre', 'usu_clave', 'usu_estado', 'usu_ganador', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UsuId' => 0, 'UsuEmail' => 1, 'UsuNombre' => 2, 'UsuClave' => 3, 'UsuEstado' => 4, 'UsuGanador' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('usuId' => 0, 'usuEmail' => 1, 'usuNombre' => 2, 'usuClave' => 3, 'usuEstado' => 4, 'usuGanador' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::USU_ID => 0, self::USU_EMAIL => 1, self::USU_NOMBRE => 2, self::USU_CLAVE => 3, self::USU_ESTADO => 4, self::USU_GANADOR => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('usu_id' => 0, 'usu_email' => 1, 'usu_nombre' => 2, 'usu_clave' => 3, 'usu_estado' => 4, 'usu_ganador' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UsuarioPeer::USU_EMAIL);
		...
		$criteria->addSelectColumn(UsuarioPeer::USU_GANADOR);
