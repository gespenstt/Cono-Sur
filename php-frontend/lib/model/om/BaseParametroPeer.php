...
abstract class BaseParametroPeer {
	...
	const PAR_ID = 'parametro.PAR_ID';

	/** the column name for the SEC_ID field */
	const SEC_ID = 'parametro.SEC_ID';

	/** the column name for the PAR_IDENTIFICADOR field */
	const PAR_IDENTIFICADOR = 'parametro.PAR_IDENTIFICADOR';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ParId', 'SecId', 'ParIdentificador', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('parId', 'secId', 'parIdentificador', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::PAR_ID, self::SEC_ID, self::PAR_IDENTIFICADOR, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('par_id', 'sec_id', 'par_identificador', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ParId' => 0, 'SecId' => 1, 'ParIdentificador' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('parId' => 0, 'secId' => 1, 'parIdentificador' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::PAR_ID => 0, self::SEC_ID => 1, self::PAR_IDENTIFICADOR => 2, self::CREATED_AT => 3, self::UPDATED_AT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('par_id' => 0, 'sec_id' => 1, 'par_identificador' => 2, 'created_at' => 3, 'updated_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	{
		$criteria->addSelectColumn(ParametroPeer::PAR_ID);
		$criteria->addSelectColumn(ParametroPeer::SEC_ID);
		$criteria->addSelectColumn(ParametroPeer::PAR_IDENTIFICADOR);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related Seccion table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinSeccion(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ParametroPeer::SEC_ID, SeccionPeer::SEC_ID, $join_behavior);
	...
	/**
	 * Selects a collection of Parametro objects pre-filled with their Seccion objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinSeccion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = SeccionPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = SeccionPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					...
					SeccionPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
				
				// Add the $obj1 (Parametro) to $obj2 (Seccion)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		SeccionPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (SeccionPeer::NUM_COLUMNS - SeccionPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = SeccionPeer::getPrimaryKeyHashFromRow($row, $startcol2);
			if ($key2 !== null) {
				$obj2 = SeccionPeer::getInstanceFromPool($key2);
				if (!$obj2) {
				...
				// Add the $obj1 (Parametro) to the collection in $obj2 (Seccion)
				$obj2->addParametro($obj1);
	...
	{
		return $withPrefix ? ParametroPeer::CLASS_DEFAULT : ParametroPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseParametroPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseParametroPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(ParametroPeer::PAR_ID) && $criteria->keyContainsValue(ParametroPeer::PAR_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ParametroPeer::PAR_ID.')');
		}
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseParametroPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseParametroPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseParametroPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseParametroPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ParametroPeer::PAR_ID);
			$selectCriteria->add(ParametroPeer::PAR_ID, $criteria->remove(ParametroPeer::PAR_ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseParametroPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseParametroPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ParametroPeer::PAR_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ParametroPeer::PAR_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ParametroPeer::DATABASE_NAME);
			$criteria->add(ParametroPeer::PAR_ID, $pks, Criteria::IN);
