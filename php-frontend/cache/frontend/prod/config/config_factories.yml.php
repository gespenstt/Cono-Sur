...
// date: 2015/05/07 22:21:23
  ...
  'cache_dir' => 'D:\\GIT\\Cono-Sur\\php-frontend\\cache\\frontend\\prod\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'D:\\GIT\\Cono-Sur\\php-frontend\\apps\\frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'D:\\GIT\\Cono-Sur\\php-frontend\\cache\\frontend\\prod\\template',
  'lifetime' => 86400,
  'prefix' => 'D:\\GIT\\Cono-Sur\\php-frontend\\apps\\frontend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    'param' => 
    array (
      'host' => 'mail.insydev.com',
      'port' => 25,
      'encryption' => NULL,
      'username' => 'no.reply@bloggercompetition.conosur.com',
      'password' => 'c0n0sur',
    ),
  ),
))));
