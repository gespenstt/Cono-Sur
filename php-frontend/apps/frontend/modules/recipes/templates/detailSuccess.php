<?php
    ...
    slot('social_title',iconv("UTF-8", "ISO-8859-1//TRANSLIT", $receta->getRecNombreReceta()));
    slot('social_desc',iconv("UTF-8", "ISO-8859-1//TRANSLIT", $receta->getRecInstrucciones()));
